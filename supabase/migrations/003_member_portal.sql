...
CREATE TABLE IF NOT EXISTS public.announcements (
  ...
  target_audience TEXT DEFAULT 'all' -- 'all', 'members', 'youth', etc.
);
...
CREATE INDEX idx_announcement_reads_member ON public.announcement_reads(member_id);
...
CREATE INDEX idx_poll_votes_member ON public.poll_votes(member_id);
