...
/>
      ...
      <div className="blocks-container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-8 px-4 sm:px-8 lg:px-40 -translate-y-16 sm:-translate-y-24 lg:-translate-y-32">
        <div className="block know-god bg-gradient-to-br from-[#33869b] to-[#197fa4] text-white p-8">
          <p className="text-2xl font-bold text-left pt-24 sm:pt-32">EXPERIENCE GOD</p>
        </div>
  ...
  <p className="text-lg text-center m-8">
    Serving Church is a vibrant community united in our mission to reflect Christ more closely each day. No matter
    where you come from or what your story is, you are welcome to join us in our journey of faith and service. Our
    guiding principle, inspired by John 13:15, calls us to emulate Christ&apos;s example: &quot;For I have given you an
    example, that you also should do just as I have done to you.&quot; At Serving Church, you&apos;ll discover a family
    committed not just to the organization but to the transformative power of living for something greater than
    ourselves. We believe that a strong church is built on members who are devoted to this mission. Here, you will
    find a place to belong and grow in the fullness of life that God intends for us all. Welcome Home!
  </p>
