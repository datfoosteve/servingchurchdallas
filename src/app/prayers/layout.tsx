...
export const metadata: Metadata = {
  title: "Prayer Wall | The Serving Church",
  ...
  openGraph: {
    ...
    description: "Join us in prayer. Lift each other up, share burdens, and celebrate answered prayers together as a church family.",
    type: "website",
    locale: "en_US",
